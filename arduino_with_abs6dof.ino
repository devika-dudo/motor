...
const int dirPins[6] = {25, 26, 8, 7, 12, 10};  // Direction control pins
const int pwmPins[6] = {24, 27, 6, 5, 11, 9}; // PWM control pins  
...
void parseCommand(String command) {
  ...
  for (int i = 0; i < 6; i++) {
    ...
    moveRelative(i, relativeMove);                  // Move joint i relatively by difference
      ...
      Serial.println("MOVEALL <ticks1> <ticks2> <ticks3> <ticks4> <ticks5> <ticks6> - Relative movement for all motors");
      Serial.println("MOVEALLREL <ticks1> <ticks2> <ticks3> <ticks4> <ticks5> <ticks6> - Explicit relative movement for all motors");
